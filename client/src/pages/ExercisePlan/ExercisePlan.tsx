...
function App() {
  const [exercises, setExercises] = useState(
    new Array<ExerciseCardData>(NB_EXERCISES)
  );
  ...
  let handleRemoveExerciseOnClick = (
  ...
  let handleOnCheckEquipment = (
    ...
    if (value != null && value != undefined) {
      ...
      if (e.target.checked) {
        ...
        setCheckedEquipmentList(
          checkedEquipmentList.filter((item) => item != value)
        );
      }
    }
  };
          ...
          <div className="div-equipment-list">
            {
              ...
              initData.equipmentArray.length > 0 &&
              initData.equipmentArray[0] != "" ? (
                initData.equipmentArray.map((item, i) => (
                  <CheckBox
                    ...
                    isDefaultChecked={
                      Object.values(item)[0] == "body weight" ? true : false
                    }
                  />
                ))
              ) : (
